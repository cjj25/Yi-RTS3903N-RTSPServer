...
typedef enum {
	...
	H264ENC_INTERLACED_FIELD = 5,           /* H.264 stream coded as fields
                                                   of interlaced video */
	H264ENC_SMART_H264_VIEW_BUFFER = 6,     /*Smart H264*/
} H264EncViewMode;
...
typedef enum {
	...
	H264ENC_SP_FRAME = 2,           /*super p frame*/
	H264ENC_NONIDR_INTRA_FRAME = 3, /* Non-IDR I-frame or field */
...
typedef struct {
	...
	float mbrc_qp_gain;
	i32 mbrc_qp_delta_range;

	u32 br_level;

	u32 smart_h264_vbr_en;
	u32 smart_h264_max_bitrate;
	u32 smart_h264_min_bitrate;
	u32 smart_h264_min_gop;
	u32 smart_h264_max_gop;

	u32 smart_h264_diff_thd;
	u32 smart_h264_diff_percentage;
	u32 rc_mode;
	u32 gop_mode;
	u32 smart_h264_sp_period;
...
H264EncRet H264EncInit_V2(const H264EncConfig *pEncCfg, H264EncInst *instAddr,
				int bind_fd, void *pbuf);
...
H264EncRet H264EncStrmEncode(H264EncInst inst, H264EncIn *pEncIn,
		H264EncOut *pEncOut,
		H264EncSliceReadyCallBackFunc cbFunc,
		void *pAppData);
...
H264EncRet H264EncGetMbSizeInfo(H264EncInst inst,
		struct H264MBSizeInfo *mb_size_info);
/*------------------------------------------------------------------------------
...
int H264EncSetEpollHook(H264EncInst inst, void *master,
			int (*hook_func)(void *master, int fd));
int H264EncCheckDone(H264EncInst inst);
int H264EncMakeRdy(H264EncInst inst);
int H264EncUseSigio(H264EncInst inst, int sigio_need);
#ifdef __cplusplus
}
#endif
